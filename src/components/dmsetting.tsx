...
const DMSetting = ({
  ...
  let className =
    "PlayerIconButton-playerButton-zDmEsI IconButton-button-s4bVCh danmaku-button";
  if (!on) {
    className += " danmaku-setting-disable";
  }
  return (
    <>
      <button {...rest} className={className} type="button" role="button">
        <BiliSettingSVG />
      </button>
    </>
  );
